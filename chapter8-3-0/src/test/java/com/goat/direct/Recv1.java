...
public class Recv1 extends CommonTest {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        channel.queueBind(QUEUE1, DIRECT_EXCHANGE_NAME, "insert");
        channel.queueBind(QUEUE1, DIRECT_EXCHANGE_NAME, "update");
        channel.queueBind(QUEUE1, DIRECT_EXCHANGE_NAME, "delete");
        // 定义队列的消费者
