...
public class MathTest {
    ...
    @Test
    public void round(){
        // 四舍五入取整  1.大于五全加  2.等于五正数加 3.小于五全不加
        System.out.println("Math.round(7.2 )：" + Math.round(7.2)); // 0.2 小于五全不加
        System.out.println("Math.round(-7.2 )：" + Math.round(-7.2)); // 0.2 小于五全不加
        System.out.println("Math.round(11.5 )：" + Math.round(11.5)); // 等于五正数加
        System.out.println("Math.round(-11.5 )：" + Math.round(-11.5));
        System.out.println("Math.round(11.68 )：" + Math.round(11.68)); // 大于五全加 12
        System.out.println("Math.round(-11.68 )：" + Math.round(-11.68)); // 大于五全加 -12
    }

	// [0.0,1.0) / [0.0,1.0) 的值   大于等于0.0 小于1.0
	@Test
    public void test(){
        System.out.println(Math.random()/Math.random());
    }
