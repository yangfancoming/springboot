...
public class App2 {
    ...
    */
    public static void main(String[] args) {
        ...
        for(int i=0;i<10000;i++) { // for循环是为了让生产者和消费者隔开一段时间，以展示offer的效果
            int a = i*2312/234*12;
        }
    ...
    /*  参看图 阻塞队列.png
        ...
        这个和put不一样，put会一直等待，就是说程序会一直停留在blockingQueue.put那一句，offer会跳过blockingQueue.offer那一句，
        而进入下一个while循环，这样实际插入队列的数字就会不连续了。
    */
}
