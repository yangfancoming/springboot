 ...
 */
public class ByteArrayUtilsTest extends TestData {

    @Test
    public void byteArrToHexString1() {
        String hexString = ByteArrayUtils.byteArrToHexString(primitiveArray);
        Assert.assertEquals("[38,03,00,00,00,05]", hexString);
    }

    @Test
    public void byteArrToHexStringUpperCase() {
        String hexString = ByteArrayUtils.byteArrToHexString(foo,true);
        Assert.assertEquals("[7E,09,0A]", hexString);
    }

    @Test
    public void byteArrToHexStringLowerCase() {
        String hexString = ByteArrayUtils.byteArrToHexString(foo,false);
        Assert.assertEquals("[7e,09,0a]", hexString);
    }
    ...
    public void convertToPrimitiveArray() {
        ...
        String hexString = ByteArrayUtils.byteArrToHexString(bytes);
        Assert.assertEquals("[02,05,00,03,FF,00]", hexString);
    }

    @Test
    public void convertToPrimitiveAr1ray() {
        Byte[] bytes = ByteArrayUtils.convertToObjectArray(primitiveArray);
    ...
    public void byteArrToShort() {
        ...
        short s = ByteArrayUtils.byteArrToShort(bytes);
    ...
    */
    ...
    public void reverseArray() {
        ...
        byte[] s = ByteArrayUtils.reverseArray(bytes);
    ...
    public void test() {
        ...
        bytes2[0] = bytes[2];
        bytes2[1] = bytes[3];
        short s = ByteArrayUtils.byteArrToShort(bytes2);
