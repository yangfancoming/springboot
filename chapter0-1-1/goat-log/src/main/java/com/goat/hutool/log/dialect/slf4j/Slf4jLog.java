package com.goat.hutool.log.dialect.slf4j;


import com.goat.hutool.log.AbstractLocationAwareLog;
...
public class Slf4jLog extends AbstractLocationAwareLog {
	...
	private boolean locationAwareLog(String fqcn, int level_int, Throwable t, String msgTemplate, Object[] arguments) {
		if (this.logger instanceof LocationAwareLogger) {
			...
			((LocationAwareLogger) this.logger).log(null, fqcn, level_int, String.format(msgTemplate, arguments), null, t);
			return true;
		} else {
			return false;
		}
