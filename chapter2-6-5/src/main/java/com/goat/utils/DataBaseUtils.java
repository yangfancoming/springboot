...
public class DataBaseUtils {
     ...
     *      5.封装到java对象中即可
     */
    public static List<Table> getDbInfo(DataBase db,String _tableName) throws  Exception {
        //1.获取连接
        Connection connection = getConnection(db);
        //2.获取元数据
        DatabaseMetaData metaData = connection.getMetaData();
        //3.获取当前数据库中的所有表
        ResultSet tables = metaData.getTables(null, null, _tableName, new String[]{"TABLE"});
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Table> dbInfo = DataBaseUtils.getDbInfo(db,"book");
